  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto">
        {!displayDrug ? (
          <div className="flex flex-col items-center justify-center p-12 bg-gradient-to-br from-slate-50 to-cyan-50 rounded-3xl shadow-lg border border-slate-200 transition-all duration-500 hover:shadow-xl">
          ...
          <div className="bg-white rounded-3xl shadow-lg overflow-hidden border border-slate-200 transition-all duration-500 hover:shadow-2xl animate-fade-in">
            ...
            <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 p-8 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-4xl font-bold mb-2 transition-all duration-300">{displayDrug.name}</h2>
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 transition-all duration-300 hover:shadow-md hover:border-slate-200 group">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-600 leading-relaxed text-lg transition-all duration-300">{displayDrug.purpose}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 transition-all duration-300 hover:shadow-md hover:border-slate-200 group">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-600 leading-relaxed text-lg transition-all duration-300">{displayDrug.dosage}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 transition-all duration-300 hover:shadow-md hover:border-slate-200 group">
                ...
                <div className="bg-white p-4 rounded-xl backdrop-blur-sm border border-slate-100">
                  <p className="text-slate-600 leading-relaxed text-lg animate-fade-in">{displayDrug.howToUse}</p>
                </div>
              </div>
            </div>

           
            <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 px-8 py-6 relative overflow-hidden">
