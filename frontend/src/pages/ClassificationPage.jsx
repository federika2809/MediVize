...
const AccuracyIndicator = ({ confidence }) => {
  ...
  return (
    <div className="mt-4">
      ...
      <div className="flex items-center">
        ...
        <span className={`ml-3 text-sm font-medium px-2 py-1 rounded-full ${colorClass}`}>
          {percentage}%
        </span>
      </div>
 ...
 return (
            ...
            >
                ...
                <div className="text-center mb-12">
                    <motion.div
                        ...
                        className="inline-flex items-center justify-center w-20 h-20 bg-cyan-500 rounded-2xl mb-6 shadow-lg"
                    >
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                        {tips.map((tip, index) => (
                            ...
                            >
                                <div className="w-12 h-12 bg-cyan-500 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-sm">
                    ...
                    <div className="p-8">
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="font-semibold text-cyan-800 mb-1">Gambar Siap Diproses!</p>
                                        <p className="text-cyan-700 text-sm">
                                            {selectedImage.name} 
                                            <span className="ml-2 px-2 py-1 bg-cyan-200 text-cyan-800 rounded-full text-xs">
                        ...
                        {error && (
                            <motion.div
                                ...
                                className="mt-6 p-4 bg-red-100 border border-red-200 rounded-xl"
                            >
                        ...
                        <div className="flex justify-center mt-8">
                            ...
                            >
                                <Button 
                                    ...
                                    variant="primary"
                                    className="px-12 py-4 text-lg font-semibold !bg-cyan-500 hover:!bg-cyan-600 !text-white transition-all duration-300 shadow-md hover:shadow-lg rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                    ...
                    >
                        <div className="bg-white rounded-2xl p-10 shadow-lg max-w-md mx-auto border border-gray-200">
                            <div className="relative mb-6">
                                <div className="animate-spin rounded-full h-16 w-16 border-4 border-gray-200 border-t-cyan-500 mx-auto"></div>
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <Image className="h-8 w-8 text-cyan-500" />
                                </div>
                            </div>
                            
                            <h3 className="text-xl font-bold text-gray-800 mb-2">Menganalisis Kemasan Obat</h3>
                    ...
                    >
                        <div className="text-center mb-8">
                            <motion.div
                                ...
                                className="inline-flex items-center justify-center w-16 h-16 !bg-cyan-500 rounded-full mb-4 shadow-lg"
                            >
                            ...
                            <p className="text-gray-600">Berikut hasil identifikasi kemasan obat Anda</p>
                        </div>
                            ...
                            <div className="md:flex">
                                ...
                                <div className="md:w-1/2 p-6 border-b md:border-b-0 md:border-r border-gray-200">
                                    <h3 className="font-bold text-lg text-gray-800 mb-4 flex items-center">
                                        <Image className="h-5 w-5 mr-2 text-cyan-500" />
                                        Foto Kemasan Anda
                                    </h3>
    ...
    <div>
        <h4 className="text-sm font-semibold text-gray-500">Nama Obat</h4>
                ...
                {classificationResult === null && !loading && error.includes('tidak ditemukan') && (
                    ...
                    >
                        <div className="bg-white rounded-2xl p-10 text-center shadow-lg border border-gray-200">
                            <div className="w-16 h-16 bg-cyan-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm">
                                <Search className="h-8 w-8 text-white" />
                            </div>
                            
                            <h3 className="text-2xl font-bold text-gray-800 mb-4">Kemasan Obat Tidak Dikenali</h3>
                            ...
                            <div className="bg-cyan-50 border border-cyan-200 rounded-xl p-6 mb-6 text-left">
                                ...
                                <ul className="space-y-2">
                                    <li className="flex items-start">
                                        ...
                                        <span className="text-cyan-700">Nama obat terlihat jelas</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-cyan-500 mr-2">•</span>
                                        <span className="text-cyan-700">Seluruh kemasan masuk dalam frame</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-cyan-500 mr-2">•</span>
                                        <span className="text-cyan-700">Tidak ada bayangan atau silau</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-cyan-500 mr-2">•</span>
                                        <span className="text-cyan-700">Resolusi gambar cukup tinggi</span>
                                    </li>
                                </ul>
                            </div>
